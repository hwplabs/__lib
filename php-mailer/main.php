...
*/
function php_mailer_send($sub_domain, $username, $password, $from, $to, $subject, $body, $reply_to = null, $attach = null)
{
    $mail = new PHPMailer(true);
    try {
        $mail->SMTPDebug = SMTP::DEBUG_SERVER;
        $mail->isSMTP();
        $mail->Host = $sub_domain; #webmail sub-domain
        $mail->SMTPAuth = true;
        $mail->Username = $username; #webmail email
        ...
        $mail->send();
        #return true;
        return [$sub_domain, $username, $password, $from, $to, $subject, $body, $reply_to, $attach];
    } catch (Exception $e) {
