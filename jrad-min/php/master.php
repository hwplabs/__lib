...
{
    // 2020-04-21 12:47:00
    $date_time = str_replace(' ', '', $date_time); // 2020-04-2112:47:00.000000
    $date_time = str_replace('-', '', $date_time); // 2020042112:47:00.000000
    $date_time = str_replace('/', '', $date_time); // 2020042112:47:00.000000
    $date_time = str_replace(':', '', $date_time); // 20200421124700.000000
    $date_time = str_replace('.', '', $date_time); // 20200421124700000000
    $date_time = str_replace('T', '', $date_time); // 20200421124700000000
    $date_time = str_replace('Z', '', $date_time); // 20200421124700000000
