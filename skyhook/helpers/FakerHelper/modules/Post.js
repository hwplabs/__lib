...
export default class FakerPost extends FakerUser {
  ...
  // 0.0 - 50.0
  get discount() {
    return faker.commerce.price({ min: 0, max: 50, dec: 1 });
  }
  // 0.0 - 10.0
  get vat() {
    return faker.commerce.price({ min: 0, max: 10, dec: 1 });
  }
  // ////////////////////////////////////////////////////////////

  // 0.0 - 5.0
  get ratings() {
    return faker.commerce.price({ min: 0, max: 5, dec: 1 });
  }
  // 1.9k - 1.9m
  get reviews() {
    return faker.commerce.price({ min: 999, max: 999999999, dec: 0 });
  }
}
